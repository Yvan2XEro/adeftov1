...
/**
 * @Group(name="ResetPasswordLink", description="The authentication endpoint")
 */
class ForgotPasswordAPIController extends Controller
{
     ...
     */
    /**
     * @Endpoint(name="sendResetPasswordLink")
     * @ResponseExample(status=200, file="responses/auth/resetpasswordlink.json")
     * @ResponseExample(status=422, file="responses/auth/resetpassworderror.json")
     */
